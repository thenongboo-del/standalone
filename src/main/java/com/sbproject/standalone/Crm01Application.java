...
//			m0.setAge(35);
			//추가정보
			m0.setBirthDay(LocalDate.parse("1990-10-15"));
...
//			m1.setAge(41);
			//추가정보
			m1.setBirthDay(LocalDate.parse("1984-03-11"));
...
//			m2.setAge(25);
			//추가정보
			m2.setBirthDay(LocalDate.parse("1998-05-01"));
...
//			m3.setAge(23);
			...
			m3.setBirthDay(LocalDate.parse("1901-05-01"));
...
//			m3.setAddress(a3);
			...
			m4.setGender("여성");
//			m4.setAge(26);
			m4.setBirthDay(LocalDate.parse("1998-01-11"));
...
//			m4.setAddress(a4);
			...
			m5.setGender("남성");
//			m5.setAge(26);
			m5.setBirthDay(LocalDate.parse("1998-12-28"));
...
//			m5.setAddress(a5);
			...
			m6.setGender("남성");
//			m6.setAge(29);
			m6.setBirthDay(LocalDate.parse("1995-10-18"));
...
//			m6.setAddress(a6);
			...
			m7.setGender("여성");
//			m7.setAge(32);
			m7.setBirthDay(LocalDate.parse("1992-08-08"));
...
//			m7.setAddress(a7);
			...
			m8.setGender("여성");
//			m8.setAge(35);
			m8.setBirthDay(LocalDate.parse("1990-06-01"));
...
//			m8.setAddress(a8);
			...
			m9.setGender("남성");
//			m9.setAge(42);
			m9.setBirthDay(LocalDate.parse("1983-05-05"));
...
//			m9.setAddress(a9);
			...
			m10.setGender("여성");
//			m10.setAge(51);
			m10.setBirthDay(LocalDate.parse("1974-10-01"));
